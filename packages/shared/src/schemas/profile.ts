...
/** Смена адреса до подтверждения — спасение от опечатки.
 *
 *  Без неё жёсткая проверка почты превращается в ловушку: человек,
 *  промахнувшийся одной буквой при регистрации, не может ни войти,
 *  ни исправить адрес, потому что письмо уходит в никуда.
 *
 *  Пароль обязателен: адрес — это ключ к восстановлению доступа,
 *  и менять его по одной лишь открытой вкладке нельзя. */
