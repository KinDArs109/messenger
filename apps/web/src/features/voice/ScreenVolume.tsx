 ...
 * уже там. Пока на кадр не навели — значка не видно, чтобы он
 * не закрывал собой то, ради чего смотрят.
 */
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Как и кнопка «развернуть»: на мыши появляется при наведении,
        // на телефоне и во весь экран видна всегда — наводить там
        // нечем и некуда.
        open
          ? ""
          : big
            ? ""
            : "opacity-0 transition-opacity focus-within:opacity-100 group-hover/screen:opacity-100 pointer-coarse:opacity-100",
      )}
    >
      {open && (
