...
void app
  ...
  // Steam-игры находятся не только через RunningAppID: его Steam
  // пишет лишь когда игру запускают из него самого.
  ok("в сборке есть запасной поиск игры Steam", insidePackage("pickRunning") === true);
